...
<body>
    <div class="container mt-5">
        ...
        <!-- Formulario para editar la colección -->
        <form action="{{ route('colecciones.update', $coleccion->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" value="{{ old('nombre', $coleccion->nombre) }}" required>
            </div>

            <div class="mb-3">
                <label for="descripcion" class="form-label">Descripción</label>
                <textarea class="form-control" id="descripcion" name="descripcion">{{ old('descripcion', $coleccion->descripcion) }}</textarea>
            </div>
